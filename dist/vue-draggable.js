...
`,m=a(),f=m({name:"x-draggable",template:c,emits:["drag-start","drag-move","drag-end"],props:{"is-locked":{type:Boolean,required:!1,default:()=>!1},x:{type:Number,required:!1,default:()=>0},y:{type:Number,required:!1,default:()=>0}},data(){return{css:h,isBeingDragged:!1,mouseButtonIsDown:!1,offset:{x:0,y:0}}},watch:{x(){this.$refs.root.style.position="absolute",this.$refs.root.style.left=this.x+"px"},y(){this.$refs.root.style.position="absolute",this.$refs.root.style.top=this.y+"px"}},methods:{onMouseDown(e){if(this.isLocked)return;let t=this.$refs.root.getBoundingClientRect();this.mouseButtonIsDown=!0,this.offset.x=e.clientX-t.x,this.offset.y=e.clientY-t.y},onMouseMove(e){if(!this.isLocked&&(this.mouseButtonIsDown&&!this.isBeingDragged&&(this.$emit("drag-start",this.$refs.root.getBoundingClientRect()),this.isBeingDragged=!0),this.isBeingDragged)){this.$emit("drag-move",this.$refs.root.getBoundingClientRect());let t=this.$refs.root.parentElement.getBoundingClientRect();this.$refs.root.style.position="absolute",this.$refs.root.style.left=e.clientX-this.offset.x-t.x+"px",this.$refs.root.style.top=e.clientY-this.offset.y-t.y+"px"}},onMouseUp(){this.isLocked||(this.isBeingDragged&&this.$emit("drag-end",this.$refs.root.getBoundingClientRect()),this.mouseButtonIsDown=!1,this.isBeingDragged=!1)}},mounted(){this.isLocked||(window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp),this.$refs.root.style.position="absolute")},unmounted(){this.isLocked||(window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp))}});typeof r<"u"&&(r.exports=f);typeof globalThis<"u"&&(globalThis.VueDraggableComponent=f)});b();})();
