(()=>{var u=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var a=u((m,n)=>{function d(e){let t=0,s;e=e||{};let i=e.data?e.data:function(){},l=e.mounted?e.mounted:function(){},g=e.unmounted?e.unmounted:function(){};return i.css||(i.css=""),e.data=function(){let o=this;return i.bind(o)()},e.mounted=function(){let o=this;l.bind(o)(),t++,s||(s=document.createElement("style"),document.body.appendChild(s),s.innerHTML=o.css)},e.unmounted=function(){let o=this;g.bind(o)(),t--,t<1&&(document.body.removeChild(s),s=null)},e}typeof n<"u"&&(n.exports=d);typeof window<"u"&&(window.createVueComponentWithCSS=d)});var p=u((v,r)=>{var c=`
  .vue-draggable {
    cursor: default;
  }
